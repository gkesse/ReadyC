...
struct ns__addResponse;	/* srv/service.h:1 */
struct ns__add;	/* srv/service.h:1 */
struct ns__subResponse;	/* srv/service.h:2 */
struct ns__sub;	/* srv/service.h:2 */
struct ns__mulResponse;	/* srv/service.h:3 */
struct ns__mul;	/* srv/service.h:3 */
struct ns__divResponse;	/* srv/service.h:4 */
struct ns__div;	/* srv/service.h:4 */
struct ns__powResponse;	/* srv/service.h:5 */
struct ns__pow;	/* srv/service.h:5 */
...
\******************************************************************************/
    ...
    /** Web service synchronous operation 'soap_call_ns__mul' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_send_ns__mul' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_recv_ns__mul' to receive a response message from the connected endpoint, returns SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns__mul(struct soap *soap, double *result);
    
    /** Web service synchronous operation 'soap_call_ns__div' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_send_ns__div' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_recv_ns__div' to receive a response message from the connected endpoint, returns SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns__div(struct soap *soap, double *result);
    
    /** Web service synchronous operation 'soap_call_ns__pow' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_send_ns__pow' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_recv_ns__pow' to receive a response message from the connected endpoint, returns SOAP_OK or error code */
...
\******************************************************************************/
    ...
    /** Web service operation 'ns__mul' implementation, should return SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 ns__mul(struct soap*, double a, double b, double *result);
    /** Web service operation 'ns__div' implementation, should return SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 ns__div(struct soap*, double a, double b, double *result);
    /** Web service operation 'ns__pow' implementation, should return SOAP_OK or error code */
