/* soapC.c
   Generated by gSOAP 2.8.101 for srv/service.h
...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.101 2020-07-05 21:39:43 GMT")
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in src\\soapC.c\n", tag ? tag : "", type));
...
SOAP_FMAC3 struct ns__pow * SOAP_FMAC4 soap_in_ns__pow(struct soap *soap, const char *tag, struct ns__pow *a, const char *type)
{
	...
	{	a = (struct ns__pow *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__pow, SOAP_TYPE_ns__pow, sizeof(struct ns__pow), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	struct ns__pow *p;
	struct ns__pow *a = (struct ns__pow*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__pow));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__powResponse * SOAP_FMAC4 soap_in_ns__powResponse(struct soap *soap, const char *tag, struct ns__powResponse *a, const char *type)
{
	...
	{	a = (struct ns__powResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__powResponse, SOAP_TYPE_ns__powResponse, sizeof(struct ns__powResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns__powResponse * SOAP_FMAC4 soap_new_ns__powResponse(struct soap *soap, int n)
{
	...
	struct ns__powResponse *a = (struct ns__powResponse*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__powResponse));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__div * SOAP_FMAC4 soap_in_ns__div(struct soap *soap, const char *tag, struct ns__div *a, const char *type)
{
	...
	{	a = (struct ns__div *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__div, SOAP_TYPE_ns__div, sizeof(struct ns__div), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	struct ns__div *p;
	struct ns__div *a = (struct ns__div*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__div));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__divResponse * SOAP_FMAC4 soap_in_ns__divResponse(struct soap *soap, const char *tag, struct ns__divResponse *a, const char *type)
{
	...
	{	a = (struct ns__divResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__divResponse, SOAP_TYPE_ns__divResponse, sizeof(struct ns__divResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns__divResponse * SOAP_FMAC4 soap_new_ns__divResponse(struct soap *soap, int n)
{
	...
	struct ns__divResponse *a = (struct ns__divResponse*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__divResponse));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__mul * SOAP_FMAC4 soap_in_ns__mul(struct soap *soap, const char *tag, struct ns__mul *a, const char *type)
{
	...
	{	a = (struct ns__mul *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__mul, SOAP_TYPE_ns__mul, sizeof(struct ns__mul), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	struct ns__mul *p;
	struct ns__mul *a = (struct ns__mul*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__mul));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__mulResponse * SOAP_FMAC4 soap_in_ns__mulResponse(struct soap *soap, const char *tag, struct ns__mulResponse *a, const char *type)
{
	...
	{	a = (struct ns__mulResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__mulResponse, SOAP_TYPE_ns__mulResponse, sizeof(struct ns__mulResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns__mulResponse * SOAP_FMAC4 soap_new_ns__mulResponse(struct soap *soap, int n)
{
	...
	struct ns__mulResponse *a = (struct ns__mulResponse*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__mulResponse));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__sub * SOAP_FMAC4 soap_in_ns__sub(struct soap *soap, const char *tag, struct ns__sub *a, const char *type)
{
	...
	{	a = (struct ns__sub *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__sub, SOAP_TYPE_ns__sub, sizeof(struct ns__sub), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	struct ns__sub *p;
	struct ns__sub *a = (struct ns__sub*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__sub));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__subResponse * SOAP_FMAC4 soap_in_ns__subResponse(struct soap *soap, const char *tag, struct ns__subResponse *a, const char *type)
{
	...
	{	a = (struct ns__subResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__subResponse, SOAP_TYPE_ns__subResponse, sizeof(struct ns__subResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns__subResponse * SOAP_FMAC4 soap_new_ns__subResponse(struct soap *soap, int n)
{
	...
	struct ns__subResponse *a = (struct ns__subResponse*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__subResponse));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__add * SOAP_FMAC4 soap_in_ns__add(struct soap *soap, const char *tag, struct ns__add *a, const char *type)
{
	...
	{	a = (struct ns__add *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__add, SOAP_TYPE_ns__add, sizeof(struct ns__add), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	struct ns__add *p;
	struct ns__add *a = (struct ns__add*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__add));
	for (p = a; p && n--; p++)
...
SOAP_FMAC3 struct ns__addResponse * SOAP_FMAC4 soap_in_ns__addResponse(struct soap *soap, const char *tag, struct ns__addResponse *a, const char *type)
{
	...
	{	a = (struct ns__addResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__addResponse, SOAP_TYPE_ns__addResponse, sizeof(struct ns__addResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns__addResponse * SOAP_FMAC4 soap_new_ns__addResponse(struct soap *soap, int n)
{
	...
	struct ns__addResponse *a = (struct ns__addResponse*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns__addResponse));
	for (p = a; p && n--; p++)
