...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.101 2020-07-05 21:04:08 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns__mul(struct soap *soap, double *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__mulResponse = soap_get_ns__mulResponse(soap, NULL, "ns:mulResponse", NULL);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns__div(struct soap *soap, double *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__divResponse = soap_get_ns__divResponse(soap, NULL, "ns:divResponse", NULL);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns__pow(struct soap *soap, double *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__powResponse = soap_get_ns__powResponse(soap, NULL, "ns:powResponse", NULL);
